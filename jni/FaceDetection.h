...
extern "C" {
    ...
    void 
    JNICALL
    Java_org_openparallel_imagethresh_ImageThreshActivity_setWorkingDir(JNIEnv* env, jobject thiz, jstring f);
...
/*
 * CS are cascade selectors for object (features) to detect
 */

#define CS_EYES_SMALL 0
#define CS_EYES_LARGE 1
#define CS_FRONTAL_FACE_ALT 2
#define CS_FRONTAL_FACE_ALT2 3
#define CS_FRONTAL_FACE_TREE 4
#define CS_FRONTAL_FACE_DEFAULT 5
#define CS_FULLBODY 6
#define CS_LOWERBODY 7
#define CS_PROFILE_FACE 8
#define CS_UPPERBODY 9
#define CS_HEAD_SHOULDERS 10
#define CS_LEFT_EYE 11
#define CS_MOUTH 12
#define CS_NOSE 13
#define CS_NOSE_NEW 14
#define CS_RIGHT_EYE 15

/*
 * Private functions
 */
char* lookupHaarFeatureClassifierCascade(int cascadeSelector);
CvRect * detectFeaturesInImage(IplImage *inputImg, CvHaarClassifierCascade* cascade, CvSize minFeatureSize, int flags, float search_scale_factor);
CvRect * detectFeaturesInImageGivenHaarCascadeSelector(IplImage *inputImg, int haarFeatureClassifierCascade, CvSize minFeatureSize, int flags, float search_scale_factor);
 ...
 * Public functions
 */
IplImage* drawMoe(IplImage* inputImg);
IplImage* detectAndDrawNose(IplImage *inputImg);
IplImage* detectAndDrawFace(IplImage *inputImg);
IplImage* detectAndDrawMouth(IplImage *inputImg);
IplImage* detectAndDrawFaces(IplImage *inputImg);

IplImage* testImageForAllFeatures(IplImage *inputImg);
